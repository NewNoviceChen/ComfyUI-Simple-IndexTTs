...
tts = IndexTTS2(cfg_path="indextts/checkpoints/config.yaml", model_dir="indextts/checkpoints", use_fp16=False,
...
tts = IndexTTS(model_dir="indextts/checkpoints", cfg_path="indextts/checkpoints/config.yaml")
